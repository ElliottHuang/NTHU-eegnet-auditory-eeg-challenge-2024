...
def lstm_mel(shape_eeg, shape_spch, units_lstm=32, filters_cnn_eeg=16, filters_cnn_env=16,
    ...
    output_spch3 = env_spatial_layer(output_spch1)
    output_spch4 = env_spatial_layer(output_spch2)
    output_spch5 = env_spatial_layer(output_spch1)
    # layer
    ...
    output_spch3 = layer_reshape(output_spch3)  # size = (210,32)
    output_spch4 = layer_reshape(output_spch4)
    output_spch5 = layer_reshape(output_spch5)  # size = (210,32)
    ...
    model = tf.keras.Model(inputs=[input_eeg, input_spch1, input_spch2, input_spch3, input_spch4, input_spch5], outputs=[y_out, cos_scores_sig])
